## build_pkgdown.R
## Builds the pkgdown documentation website for qrfactor and (optionally) deploys
## it to the gh-pages branch. The manual in manual/qrfactor_manual.md is the single
## source of truth; this script regenerates it as a pkgdown article under
## vignettes/articles/ (a build artifact, git-ignored) so nothing is duplicated on
## the default branch and no HTML ever lands there.
##
...
pkg <- "C:/Users/PC/Documents/GitHub/qrfactor"
...
make_article(file.path(pkg, "manual", "qrfactor_manual.md"), "qrfactor_manual.Rmd")

## figures live next to the article so the `figures/...` links resolve
